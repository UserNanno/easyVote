...
for _ in range(891031):
    ...
    sql = "INSERT INTO votantes (dni, nombre, apellido, departamento, genero, edad, voto) VALUES (%s, %s, %s, %s, %s, %s, %s)"
    valores = (dni, nombre, apellido, departamento, genero, edad, voto)
