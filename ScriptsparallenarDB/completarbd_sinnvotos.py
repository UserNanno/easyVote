#UTILIZADO PARA LLENAR LA DB CON VOTANTES Q NO HAN REALIZADO SU VOTO
...
if conexion.is_connected():
    ...
    for _ in range(500):
        ...
        registro = (dni, nombre, apellido, region, genero, edad)  # Crear una tupla con el DNI y el nombre
        registros.append(registro)  # Agregar el registro a la lista

    insertar_sql = "INSERT INTO votantes (dni, nombre, apellido, region, genero, edad) VALUES (%s, %s, %s, %s, %s, %s)"
